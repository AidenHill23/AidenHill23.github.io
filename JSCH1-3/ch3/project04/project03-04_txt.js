...
for (let i = 0; i <= reviewers.length; i++) {
      ...
      // Add table class based on review type
      if (reviewType[i] === "P") {
      ...
      reviewCode += "<caption>" + reviewTitles[i] + "</caption> <tr><th>By</th><td>" + reviewers[i] + "</td></tr><tr><th>Review Dates </th><td>" + reviewDates[i] + "</td></tr><tr><td colspan = '2'>" + reviews[i] + "</td></tr></table>";
